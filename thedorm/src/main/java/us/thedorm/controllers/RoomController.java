...
public class RoomController {
    ...
    @GetMapping("/dorm/{id}/sex")
    ResponseEntity<ResponseObject> findByDormIdAndSex(@PathVariable Long id) {
        UserInfo user = (UserInfo) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
        List<Room> foundRooms = roomRepository.getRoomsByDorm_IdAndSex(id,user.isSex());
